...
(*
--algorithm atomic{
    variable colors = <<1, 0, 2, 2, 2>>, counter = {}, query = {}, zeroConfidence = 0, oneConfidence = 0;
    define{
    ...
    variables count = 1, decided = 2, decision = FALSE, majority = FALSE, conviction = 0, lastcol = 1  ;{
                       ...
                       THEN /\ majority' = [majority EXCEPT ![self] = TRUE]
                            ...
                            /\ IF colors'[self] # lastcol[self]
                                  ...
                                  ELSE /\ conviction' = [conviction EXCEPT ![self] = conviction[self] + 1]
                                       ...
                                       /\ UNCHANGED lastcol
                       ELSE /\ TRUE
                            /\ UNCHANGED << colors, zeroConfidence, decision, 
                                            majority, conviction, lastcol >>
               /\ pc' = [pc EXCEPT ![self] = "LOOOP"]
               /\ UNCHANGED << counter, query, oneConfidence, count, decided >>
                       ...
                       THEN /\ oneConfidence' = oneConfidence + 1
                            ...
                            /\ IF colors'[self] # lastcol[self]
                                  ...
                                  ELSE /\ conviction' = [conviction EXCEPT ![self] = conviction[self] + 1]
                                       ...
                                       /\ UNCHANGED lastcol
                       ELSE /\ TRUE
                            /\ UNCHANGED << colors, oneConfidence, decision, 
                                            conviction, lastcol >>
               /\ pc' = [pc EXCEPT ![self] = "Done"]
               /\ UNCHANGED << counter, query, zeroConfidence, count, decided, 
                               majority >>
...
\* Last modified Fri May 22 01:41:06 EDT 2020 by yashf
